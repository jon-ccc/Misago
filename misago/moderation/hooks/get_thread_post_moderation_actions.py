...
class GetThreadPostModerationActionsHookAction(Protocol):
    """
...
class GetThreadPostModerationActionsHookFilter(Protocol):
    """
    A function implemented by a plugin that can be registered in this hook.

    # Arguments

    ## `action: GetThreadPostModerationActionsHookAction`
...
class GetThreadPostModerationActionsHook(
    FilterHook[
        GetThreadPostModerationActionsHookAction,
        GetThreadPostModerationActionsHookFilter,
    ]
):
    """
    ...
    from misago.moderation.hooks import get_thread_post_moderation_actions_hook
    ...
    @get_thread_post_moderation_actions_hook.append_filter
...
get_thread_post_moderation_actions_hook = GetThreadPostModerationActionsHook()
