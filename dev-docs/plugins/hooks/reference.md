...
- [`check_lock_thread_solution_permission_hook`](./check-lock-thread-solution-permission-hook.md)
...
- [`check_unlock_thread_solution_permission_hook`](./check-unlock-thread-solution-permission-hook.md)
...
- [`approve_post_hook`](./approve-post-hook.md)
...
- [`get_post_merge_conflicts_hook`](./get-post-merge-conflicts-hook.md)
- [`get_post_merge_form_fields_hook`](./get-post-merge-form-fields-hook.md)
- [`get_thread_breadcrumbs_hook`](./get-thread-breadcrumbs-hook.md)
...
- [`merge_posts_hook`](./merge-posts-hook.md)
...
- [`unhide_post_hook`](./unhide-post-hook.md)
